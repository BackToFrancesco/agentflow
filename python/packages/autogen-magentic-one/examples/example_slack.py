"""This example demonstrates the Slack agent performing slack-related tasks."""
...
async def main() -> None:
    ...
    outlook_agent = AgentProxy(AgentId("SlackAgent", "default"), runtime)
    ...
    user_request = "Get all the messages I have received in Slack and make a summary for the messages for each channel"
